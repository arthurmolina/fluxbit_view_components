                ...
                function processOptions(options, datepicker) {
                  ...
                  if (inOpts.language) {
                    ...
                    if (lang) {
                      ...
                      var origLocale = locale || locales2[defaultLang2];
                      locale = Object.assign({
                        format: defaultFormat2,
                        weekStart: defaultWeekStart2
                      }, locales2[defaultLang2]);
                  ...
                  Object.keys(inOpts).forEach(function(key) {
                    if (inOpts[key] !== void 0 && hasProperty2(defaultOptions4, key)) {
                ...
                var DaysView = /* @__PURE__ */ function(_View) {
                  ...
                  return _createClass(DaysView2, [{
                    ...
                    value: function init(options) {
                      ...
                      if (onConstruction) {
                        var inner = parseHTML(daysTemplate2).firstChild;
                    ...
                    value: function setOptions(options) {
                      ...
                      if (options.calendarWeeks !== void 0) {
                        if (options.calendarWeeks && !this.calendarWeeks) {
                          var weeksElem = parseHTML(calendarWeeksTemplate2).firstChild;
                          this.calendarWeeks = {
                            element: weeksElem,
                  ...
                  return _createClass(MonthsView2, [{
                    ...
                    value: function init(options) {
                      ...
                      if (onConstruction) {
                        ...
                        this.grid.appendChild(parseHTML(createTagRepeat2("span", 12, {
                ...
                var Datepicker = /* @__PURE__ */ function() {
                  function Datepicker2(element) {
                    ...
                    var config2 = this.config = Object.assign({
                      ...
                      maxDate: void 0,
                      minDate: void 0
                    }, processOptions(defaultOptions4, this));
