...
function processOptions(options, datepicker) {
  ...
  Object.keys(inOpts).forEach(function(key) {
    if (inOpts[key] !== void 0 && hasProperty2(defaultOptions, key)) {
...
var reFormatTokens, reNonDateParts, knownFormats, parseFns, formatFns, listenerRegistry, _EventTarget$prototyp, addEventListener2, removeEventListener2, getComposedPath, locales, defaultOptions, range, defaultLang, defaultFormat, defaultWeekStart, pickerTemplate, daysTemplate, calendarWeeksTemplate, View, DaysView, MonthsView, YearsView, Picker, Datepicker, DateRangePicker;
...
// app/javascript/fluxbit_view_components.js
...
var FxDrawer = class extends Controller {
  ...
  toggle(event) {
    ...
    if (targetId) {
      console.warn(`Drawer with id ${targetId} toggle.`);
...
var drive = {
  ...
  unvisitableExtensions: /* @__PURE__ */ new Set([".7z", ".aac", ".apk", ".avi", ".bmp", ".bz2", ".css", ".csv", ".deb", ".dmg", ".doc", ".docx", ".exe", ".gif", ".gz", ".heic", ".heif", ".ico", ".iso", ".jpeg", ".jpg", ".js", ".json", ".m4a", ".mkv", ".mov", ".mp3", ".mp4", ".mpeg", ".mpg", ".msi", ".ogg", ".ogv", ".pdf", ".pkg", ".png", ".ppt", ".pptx", ".rar", ".rtf", ".svg", ".tar", ".tif", ".tiff", ".txt", ".wav", ".webm", ".webp", ".wma", ".wmv", ".xls", ".xlsx", ".xml", ".zip"])
};
...
var FrameView = class extends View2 {
  missing() {
...
var Idiomorph = function() {
  ...
  function morph(oldNode, newContent, config2 = {}) {
    ...
    const morphedNodes = saveAndRestoreFocus(ctx, () => withHeadBlocking(ctx, oldNode, newNode, (ctx2) => {
  ...
  const { normalizeElement, normalizeParent } = /* @__PURE__ */ function() {
    ...
    return {
      normalizeElement: normalizeElement2,
      normalizeParent: normalizeParent2
    };
  }();
  return {
    morph,
...
var unfetchableLink = (link) => link.origin !== document.location.origin || !["http:", "https:"].includes(link.protocol) || link.hasAttribute("target");
var linkToTheSamePage = (link) => link.pathname + link.search === document.location.pathname + document.location.search || link.href.startsWith("#");
...
var isUJS = (link) => link.hasAttribute("data-remote") || link.hasAttribute("data-behavior") || link.hasAttribute("data-confirm") || link.hasAttribute("data-method");
...
var PageView = class extends View2 {
...
var StreamElement = class _StreamElement extends HTMLElement {
  ...
  get beforeRenderEvent() {
    return new CustomEvent("turbo:before-stream-render", {
      ...
      detail: {
        newStream: this,
        render: _StreamElement.renderElement
      }
    });
  }
...
export {
  ...
  FxRowClick,
  FxSelectAll,
  registerFluxbitControllers
};
/*!
Turbo 8.0.13
Copyright © 2025 37signals LLC
 */
//# sourceMappingURL=/assets/fluxbit_view_components.js.map
